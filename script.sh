...
echo "#     18 | Install Python3-pip3                                            #"
echo "#     19 | Install Python3-venv                                            #"
echo "#     20 | Install Python3-dev                                            #"
echo "#                                                                          #"    
echo "############################################################################"
...
wait -n
echo "############################################################################"
echo "#            Python3-pip Installation (apt-get install python3-pip -y)     #"
echo "############################################################################"
...
wait -n
echo "############################################################################"
echo "#            Python3-venv Installation (apt-get install python3-venv -y)   #"
echo "############################################################################"
...
wait -n
echo "############################################################################"
echo "#            Python3-dev Installation (apt-get install python3-dev -y)     #"
echo "############################################################################"
